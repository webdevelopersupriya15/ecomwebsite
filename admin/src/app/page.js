...
import { LoginContext } from "./MainContext/MainContext";
...
export default function Home() {
  ...
  let Login=(event)=>{
    ...
    let userObj={
      logId:event.target.username.value,
      pass:event.target.password.value
    }
    axios.post("http://localhost:8000/admin/login",userObj)
    .then((res)=>res.data)
    .then(finalRes=>{
  ...
  return (
    <div className="w-[100%] text-red-600">
    ...
    <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
        ...
        >
          ...
          <div className="p-5 bg-white md:flex-1">
            ...
            <form onSubmit={Login} action="#" className="flex flex-col space-y-5">
